...
```bash
settings put global game_driver_all_apps 1# Performance+ Without root
...
```
```bash
wm density 390 ( default but not recommended, this is adjusted to your convenience )
```
